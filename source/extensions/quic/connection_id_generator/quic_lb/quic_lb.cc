...
Factory::createCompatibleLinuxBpfSocketOption(uint32_t concurrency, os_fd_t) {
  ...
  return absl::UnimplementedError("envoy.quic.connection_id_generator.quic_lb not available");
#endif
}
