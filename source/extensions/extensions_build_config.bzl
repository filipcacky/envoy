...
EXTENSIONS = {
    ...
    "envoy.filters.http.periodic_bytes":                "//source/extensions/filters/http/periodic_bytes:config",
    ...
    "envoy.quic.connection_id_generator.epoch_stable":  "//source/extensions/quic/connection_id_generator/epoch_stable:epoch_stable_config",
